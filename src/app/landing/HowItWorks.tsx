  ...
  <section
    ...
    <div className="flex flex-col space-y-8 sm:flex-row sm:space-x-6 sm:space-y-0">
      ...
      <Step
        ...
        description="We check against our database, finding common classifications and comparing them for the highest likelihood match."
      />
      <Step
...
const Step: React.FC<StepProps> = ({
  ...
  <div className="flex-1 text-center sm:px-2 md:px-4">
    ...
    <h3 className="mx-auto mb-2 max-w-32 content-center text-xl font-semibold text-gray-800 sm:min-h-14 lg:min-h-fit">
      {title}
    </h3>
